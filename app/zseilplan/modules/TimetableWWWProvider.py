...
class TimetableWWWProvider:
    ...
    def add_item_to_teacher_timetable(self, item: TimetableItem):
        ...
        self.timetable_data.teacher_timetable[item.teacher][item.day][item.hour].append(tmp)
        return True
    ...
    def add_item_to_timetable(self, item: TimetableItem):
        ...
        if teacher_short not in self.timetable_data.teachers:
            self.timetable_data.teachers[teacher_short] = f"{teacher_short} (brak danych)"
    ...
    def do_things(self):
        ...
        print(f"Found optimal timesteps, count: {len(self.timetable_data.best_timesteps) // 2}")
        ...
        with open("test.json", "w", encoding = "UTF-8") as f:
            ...
            output = {
                "_Copyright": "2020, Jakub Polgesek",
                "comment": "Wyeksportowano [TODO] !DEV!",
